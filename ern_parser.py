...
- Extracts baseline release metadata (release id, title, release type) using
  ...
  xml_utils.py) since DDEX namespace URIs vary by ERN version and no
...
Usage
-----
    python3 ern_parser.py path/to/ern_document.xml
"""
...
from xml_utils import first_child_text, iter_by_local_name
